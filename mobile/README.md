...
- CityForge backend running (see `../README.md`)
...
the `preview` profile, rewrites the Android wrapper to Gradle 9.3.1 during
...
1. **iOS Simulator:** Use `http://localhost:8000`
2. **Android Emulator:** Use `http://10.0.2.2:8000` (not localhost)
