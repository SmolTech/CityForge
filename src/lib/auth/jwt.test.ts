...
describe("JWT Utilities", () => {
  ...
  describe("generateAccessToken", () => {
    ...
    it("should include unique JWT ID (jti) for each token", () => {
      ...
      const decoded1 = jwt.verify(token1, TEST_SECRET) as unknown as JWTPayload; // nosemgrep: javascript.jsonwebtoken.security.jwt-hardcode.hardcoded-jwt-secret
      const decoded2 = jwt.verify(token2, TEST_SECRET) as unknown as JWTPayload; // nosemgrep: javascript.jsonwebtoken.security.jwt-hardcode.hardcoded-jwt-secret
